...
BINWATCH_TARGETS = [
    ...
    # Sovereign Privacy & CoinJoin Protocols (WabiSabi / Whirlpool / JoinMarket)
    ("WalletWasabi", "WalletWasabi", "csharp"),
    ("GingerPrivacy", "GingerWallet", "csharp"),
    ("JoinMarket-Org", "joinmarket-clientserver", "python"),
    ("dennysubke", "ashigaru-terminal", "java"),
]
...
def main():
    ...
    out_dir = os.environ.get("DIFFWATCH_OUT_DIR", os.path.join(os.path.dirname(__file__), "../data"))
